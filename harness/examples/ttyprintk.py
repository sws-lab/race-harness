from harness.state_graph import StateGraphMessageEnvelope, StateGraphResponseMessageDestination
from harness.process import Process
from harness.process_set import ProcessSet
from harness.graph_nodes import StateGraphSimpleNode, StateGraphSimpleAction, StateGraphSimpleMessage, StateGraphProductNode, StateGraphDerivedNode
...
def generate_process_set(num_of_clients: int) -> ProcessSet:
    ...
    tty_driver.add_message_mapping(Process.product_message_mapping_from(tty_clients))
