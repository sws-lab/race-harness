...
/* tty_client1: tty_client_connected_state, tty_driver: tty_driver_loading, tty_driver: tty_driver_unloaded, tty_driver: tty_driver_loaded (tty_driver_client_inactive, tty_driver_client_inactive, tty_driver_client_active), tty_driver: tty_driver_unloading, tty_client1: tty_client_disconnecting, tty_driver: tty_driver_loaded (tty_driver_client_inactive, tty_driver_client_active, tty_driver_client_active), tty_driver: tty_driver_loaded (tty_driver_client_inactive, tty_driver_client_inactive, tty_driver_client_inactive), tty_driver: tty_driver_loaded (tty_driver_client_inactive, tty_driver_client_active, tty_driver_client_inactive) */
static __harness_mutex_t mutex3;

/* tty_driver: tty_driver_loaded (tty_driver_client_inactive, tty_driver_client_inactive, tty_driver_client_active), tty_driver: tty_driver_loaded (tty_driver_client_active, tty_driver_client_inactive, tty_driver_client_active), tty_driver: tty_driver_loaded (tty_driver_client_inactive, tty_driver_client_active, tty_driver_client_active), tty_driver: tty_driver_loaded (tty_driver_client_active, tty_driver_client_active, tty_driver_client_active), tty_client3: tty_client_nodriver */
static __harness_mutex_t mutex4;

/* tty_driver: tty_driver_loaded (tty_driver_client_active, tty_driver_client_inactive, tty_driver_client_active), tty_driver: tty_driver_loaded (tty_driver_client_active, tty_driver_client_inactive, tty_driver_client_inactive), tty_driver: tty_driver_loading, tty_client2: tty_client_disconnecting, tty_driver: tty_driver_unloaded, tty_driver: tty_driver_loaded (tty_driver_client_inactive, tty_driver_client_inactive, tty_driver_client_active), tty_driver: tty_driver_unloading, tty_client2: tty_client_connected_state, tty_driver: tty_driver_loaded (tty_driver_client_inactive, tty_driver_client_inactive, tty_driver_client_inactive) */
static __harness_mutex_t mutex5;

/* tty_driver: tty_driver_loading, tty_driver: tty_driver_unloading, tty_client2: tty_client_wait_connection, tty_driver: tty_driver_unloaded */
static __harness_mutex_t mutex6;

/* tty_client3: tty_client_disconnecting, tty_driver: tty_driver_loaded (tty_driver_client_active, tty_driver_client_inactive, tty_driver_client_inactive), tty_driver: tty_driver_loading, tty_client3: tty_client_connected_state, tty_driver: tty_driver_unloaded, tty_driver: tty_driver_loaded (tty_driver_client_active, tty_driver_client_active, tty_driver_client_inactive), tty_driver: tty_driver_unloading, tty_driver: tty_driver_loaded (tty_driver_client_inactive, tty_driver_client_active, tty_driver_client_inactive), tty_driver: tty_driver_loaded (tty_driver_client_inactive, tty_driver_client_inactive, tty_driver_client_inactive) */
static __harness_mutex_t mutex7;

/* tty_driver: tty_driver_loading, tty_client3: tty_client_wait_connection, tty_driver: tty_driver_unloading, tty_driver: tty_driver_unloaded */
